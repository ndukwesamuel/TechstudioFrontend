...
import CalendarCompontent from "../CalendarCompontent";

import "./StudentAside.css";
function StudentAside() {
  return (
    <div className="bgColor4 d-none d-md-block  d-md-flex gap1 mt-md-5  flex-lg-column StudentAside ">
      <div className="  StudentAside__Calnender border  ">
        <CalendarCompontent />
      </div>

      <div className="StudentAside__shedulclass text-start  schedule-class    ">
        ...
        <div className="text-center mt-0 mb-1">
          <button className="btn btn-primary w-50 ">Start</button>
        </div>
      </div>
    </div>
  );
