      ...
      <div className="w-100 bgColor4">
        <div className="mt-5 pt-5  mt-sm-0  ">
          <div className="d-flex ps-2 gap1 mb-2">
            <h1 className="font24px Color Bold " onClick={form}>
              {" "}
              Create Class
            </h1>
          ...
          <p className="font1rem regular ps-2">
          ...
          {sch ? (
            ...
            <>
              <form
                action=""
                method="post"
                className="d-flex flex-column justify-content-center gap1"
              >
                <div className="d-flex  gap1">
                  <label htmlFor="">Topic</label>
                  <div className="width-75 width-md-75 ms-md-5 ms-5">
                ...
                <div className="d-flex gap1">
                  ...
                  <div className="d-flex gap1 ms-md-5">
                ...
                <div className="d-flex flex-column flex-md-row gap1 align-items-center">
                ...
                <div className="d-flex gap1 justify-content-md-center">
                  <button className="btn btn-primary ">Submit</button>
                  <button className="btn bgColor1">Cancle</button>
                </div>
              </form>
